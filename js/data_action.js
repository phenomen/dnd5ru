data_action = [
    ...
    },
    {
        ...
        bullets: [
            ...
            "Если вы преуспеете, цель становится захваченной. В описании состояния сказано, что его оканчивает, и вы в любой момент можете отпустить цель (действие не требуется)."
        ]
    },
    {
        title: "Толчок",
    ...
    },
    {
        ...
        bullets: [
             ...
             "<b>Стабилизированное</b> существо не делает проверки спасброска от смерти, хотя всё ещё имеет 0 хитов и остаётся без сознания. Существо перестаёт быть стабилизированным, если снова получает урон. Стабилизированное существо восстанавливает 1 хит раз в 1к4 часов."
       ]
    },
    {
        title: "Подготовка",
