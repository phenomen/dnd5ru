...
function init() {
  ...
  fill_section(data_classabilities_barbarian, "class-abilities-barbarian", "Классовые умения");
  fill_section(data_classabilities_bard, "class-abilities-bard", "Классовые умения");
  fill_section(data_classabilities_cleric, "class-abilities-cleric", "Классовые умения");
  fill_section(data_classabilities_druid, "class-abilities-druid", "Классовые умения");
  fill_section(data_classabilities_fighter, "class-abilities-fighter", "Классовые умения");
  fill_section(data_classabilities_monk, "class-abilities-monk", "Классовые умения");
  fill_section(data_classabilities_paladin, "class-abilities-paladin", "Классовые умения");
  fill_section(data_classabilities_ranger, "class-abilities-ranger", "Классовые умения");
  fill_section(data_classabilities_rogue, "class-abilities-rogue", "Классовые умения");
  //fill_section(data_classabilities_sorcerer, "class-abilities-sorcerer", "Классовые умения");
  //fill_section(data_classabilities_warlock, "class-abilities-warlock", "Классовые умения");
